    ...
    const row = `
                <tr>
                    ...
                    <td>
                        ...
                        disabled onchange="calculateAmount(this, ${this.id}, ${
      this.price
    })"
                        class="quantity">
                    </td>
...
const productList = [
  new Product(1, "iphone1", 100, 0, 0),
  new Product(2, "iphone2", 200, 0, 0),
  new Product(3, "iphone3", 300, 0, 0),
  new Product(4, "iphone4", 400, 0, 0),
  new Product(5, "iphone5", 500, 0, 0),
  new Product(6, "iphone6", 600, 0, 0),
];
